...
/*  This Quickstart for the Azure Cognitive Services Computer Vision API shows you
 *  how to detect image categories.
 */
...
func main() {
	...
	//	BEGIN - Categorize a local image.
	...
	//	BEGIN - Categorize a remote image.
	...
	//	Notify that we're beginning to analyze the local image.
	fmt.Println("\nCategorizing an image from a URL ...")
