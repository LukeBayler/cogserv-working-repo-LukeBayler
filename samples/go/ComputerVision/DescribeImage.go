 ...
 *	you how to describe both a local and a remote image.
 */
...
func main() {
	...
	//	Notify that we're beginning to analyze the local image.
	fmt.Println("\nDescribing an image from a URL ...")
