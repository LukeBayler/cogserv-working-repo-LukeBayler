 ...
 *	you how to detect faces in a local image and in a remote image.
 */
...
func main() {
	...
	//	BEGIN - Detect faces in a local image.
	...
	//  END - Detect faces in a local image.
	 ...
	 //	BEGIN - Detect faces in a remote image.
	...
	//	Notify that we're beginning to analyze the local image.
	fmt.Println("\nDetecting faces in an image from a URL ...")
