 ...
 *  you how to detect domain-specific content such as celebrities and landmarks.
 */
...
func main() {
	...
	//	BEGIN - Detect domain-specific content in a local image.
	//	Set the relative path to a local image.
	pathToLocalImage := "resources\\analyze-image.jpg"
	...
	fmt.Println("\nDetecting domain-specific content in a local image ...")
  ...
  //	END - Detect domain-specific content in a local image.
	 ...
	 //	BEGIN - Detect domain-specific content in a remote image.
	 //	Set a string variable equal to the path of a remote image.
	pathToRemoteImage := "https://github.com/Azure-Samples/cognitive-services-sample-data-files/raw/master/ComputerVision/Images/landmark.jpg"
	...
	//	Notify that we're beginning to analyze the remote image.
	fmt.Println("\nDetecting domain-specific content in a remote image ...")
