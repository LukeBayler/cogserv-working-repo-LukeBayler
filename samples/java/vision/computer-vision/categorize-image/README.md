...
# Sample Code for Categorizing Images with Computer Vision

This sample code shows you how to categorize images with the Computer Vision API.
...
For more information about categorizing images with the Computer Vision API, visit the [official documentation site](https://docs.microsoft.com/en-us/azure/cognitive-services/computer-vision/concept-categorizing-images).
